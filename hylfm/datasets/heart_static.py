...
from hylfm.transforms.affine_utils import get_ls_shape, get_precropped_ls_roi_in_raw_ls, get_precropped_ls_shape
...
def get_tensor_info(tag: str, name: str, meta: dict):
    ...
    if tag in ["beads_ref_Heart_tightCrop", "beads_ref_staticHeartFOV"]:
    ...
    elif tag in ["heart_2020_02_fish1_static", "heart_2020_02_fish2_static"]:
        crop_name = tag
        transformations = get_transformations(name, tag, meta=meta)
        if tag == "heart_2020_02_fish1_static":
            location = "LF_partially_restored/LenseLeNet_Microscope/20210214_static_dynamic_Heart_revision2/fish/8988_8749/fish1_static/"
        ...
        if name == "lf":
            ...
            location = location.replace("LF_partially_restored/", "LF_computed/")
            location += "*/stack_0_channel_0/TP_00000/RCout/Cam_Right_001.tif"
        elif name == "ls" or name == "ls_trf":
