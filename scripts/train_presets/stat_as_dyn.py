...
if __name__ == "__main__":
    train(
        dataset=DatasetChoice.heart_static_fish2_f4_sliced,
        batch_multiplier=2,
        batch_size=5,
        crit_apply_weight_above_threshold=False,
        crit_beta=1.0,
        crit_decay_weight_by=0.9,
        crit_decay_weight_every_unit=PeriodUnit.iteration,
        crit_decay_weight_every_value=400,
        crit_decay_weight_limit=1.0,
        crit_ms_ssim_weight=0.01,
        crit_threshold=1.0,
        crit_weight=0.001,
        criterion=CriterionChoice.WeightedSmoothL1_MS_SSIM,
        data_range=1.0,
        eval_batch_size=5,
