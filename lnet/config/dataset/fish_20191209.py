...
fish1_20191209_0216_static_affine = NamedDatasetInfo(
    ...
    trf_out_shape=(838, 1273, 1463),
    DefaultAffineTransform=Heart_tightCrop_Transform,
)
...
# fish2
fish2_20191209_0815_static = NamedDatasetInfo(
    Path(
    ...
    "stack_3_channel_0/TP_*/RC_rectified/Cam_Right_001_rectified.tif",
    "stack_4_channel_1/TP_*/LC/Cam_Left_registered.tif",
    "fish2_20191209_0815_static",
    length=1,
    x_shape=(1273, 1463),
    y_shape=(838, 1273, 1463),
)
fish2_20191209_0815_static_affine = NamedDatasetInfo(
    Path(
        "/g/kreshuk/LF_partially_restored/LenseLeNet_Microscope/20191208_dynamic_static_heart/fish2/static/Heart_tightCrop/5steps_stepsize8/2019-12-09_08.15.07"
    ),
    "stack_3_channel_0/TP_*/RC_rectified/Cam_Right_001_rectified.tif",
...
fish2_20191209_0815_static_lr = NamedDatasetInfo(
    Path("/g/kreshuk/"),
