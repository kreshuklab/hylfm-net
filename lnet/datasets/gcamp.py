...
g20200311_102114_155_ls_tif = TensorInfo(
    name="ls",
    root="GKRESHUK",
...
g20200309_093152_0_lf = TensorInfo(
    name = "lf",
    root = "GKRESHUK",
    location="TestOutputGcamp/LenseLeNet_Microscope/20200309_Gcamp/fish4_promising/singlePlanes/fov2/2020-03-09_09.31.52/stack_*_channel_4/*/TP_00000/RC_rectified/Cam_Right_*_rectified.tif",
    insert_singleton_axes_at=[0, 0],
...
g20200309_093152_0_ls = TensorInfo(
    name = "ls",
    root = "GKRESHUK",
    location="LenseLeNet_Microscope/20200309_Gcamp/fish4_promising/singlePlanes/fov2/2020-03-09_09.31.52/stack_*_channel_4/Cam_Left_00000.h5/Data",
    transformations=deepcopy(from_h5),
    insert_singleton_axes_at=[0, 0],
    samples_per_dataset=600,
    tag = "g20200309_093152_0",
...
g20200309_093152_1_lf = TensorInfo(
    name = "lf",
    root = "GKRESHUK",
    location="TestOutputGcamp/LenseLeNet_Microscope/20200309_Gcamp/fish4_promising/singlePlanes/fov2/2020-03-09_09.31.52/stack_*_channel_4/*/TP_00001/RC_rectified/Cam_Right_*_rectified.tif",
    insert_singleton_axes_at=[0, 0],
...
g20200309_093152_1_ls = TensorInfo(
    name = "ls",
    root = "GKRESHUK",
    location="LenseLeNet_Microscope/20200309_Gcamp/fish4_promising/singlePlanes/fov2/2020-03-09_09.31.52/stack_*_channel_4/Cam_Left_00001.h5/Data",
    transformations=deepcopy(from_h5),
    insert_singleton_axes_at=[0, 0],
    samples_per_dataset=600,
    tag = "g20200309_093152_1",
...
if __name__ == "__main__":
    ...
    for info_lf, info_ls in zip(
        ...
        s0 = dsls[0]["ls"][0, 0, 0]
        imageio.imwrite("/g/kreshuk/LF_computed/lnet/debug3.tif", s0)
